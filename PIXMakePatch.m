function [instID, matrixID] = PIXMakePatch( x1, y1, x2, y2, z, name );

% function [instID] = PIXMakePatch( x1, y1, x2, y2, z, name );
%
%   make a Patch -- an area of every pixel between X1,Y1/X2,Y2
%    name it 'name'. 
%
...
matrixID = PIXAddMatrix( instID, x1, y1, x2, y2, z, .1, .1, name );


%
% $Id: PIXMakePatch.m 21 2016-02-11 22:21:37Z  $
%
% $Log: PIXMakePatch.m,v $
